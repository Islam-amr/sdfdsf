...
class ReviewConsult2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <SafeAreaView style={Styles.MainView}>
                ...
                <ImageBackground style={{ width: '100%', height: Diem.height * 0.64 }} source={require('../Assets/Layer8570.png')}>
                    ...
                    {/* Notice Text */}
                    <View style={{ width: Diem.width, height: Diem.height * 0.05, justifyContent: 'center', alignItems: 'center' }}>
                        <Text style={{ fontSize: FontSize.mini.fontsize, width: '70%', textAlign: 'center' }}>{Strings.uploadpng}</Text>
                    </View>
...
export default connect(mapToStateProps)(ReviewConsult2);
