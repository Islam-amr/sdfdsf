...
class DraftingContract5 extends Component {
    ...
    HandlePartyOneCom(draftingContract5) {
        const Submit = () => {
            let newCommitments = draftingContract5.Commitments.concat(this.state.MainCom)
            this.props.navigation.navigate('DraftingContract7', { Contract_Sub_Dur: draftingContract5.Contract_Sub_Dur, Party1: draftingContract5.Party1, Party2: draftingContract5.Party2, Commitments: newCommitments })
        };
    ...
    render() {
        ...
        const DraftingContract5 = this.props.route.params;

        console.log(DraftingContract5);
        ...
        return (
            <SafeAreaView style={Styles.MainView}>
                ...
                <View style={{ width: Diem.width, height: Diem.height * 0.1, flexDirection: RTL ? 'row' : 'row-reverse' }}>
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: RTL ? 'flex-start' : 'flex-end' }}>
                        <TouchableOpacity
                            onPress={() => this.HandlePartyOneCom(DraftingContract5)}
                            style={{ width: '60%', height: '40%', justifyContent: 'center', marginHorizontal: '2.5%' }}
                        >
                            <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0.5, y: 2 }}
                                locations={[0, 1, 0.5]}
